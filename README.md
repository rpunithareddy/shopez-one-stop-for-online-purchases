...
📁 Project Structure
SHOPEZ/ client/ → Frontend (React) server/ → Backend (Node + Express) README.md → Project documentation
...
Cart
POST /api/cart/add GET /api/cart/:userId DELETE /api/cart/remove/:id

Orders
POST /api/orders GET /api/orders/:userId GET /api/orders/admin
